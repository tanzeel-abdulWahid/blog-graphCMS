    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
            <div className='relative overflow-hidden shadow-md pb-80 mb-6'>
                ...
                className="object-top absolute h-80 w-full object-fit shadow-lg rounded-t-lg lg:rounded-lg"/>
            </div>
            ...
            <div className='text-center'>
                <Link href={`/post/${post.slug}`}>
                    ...
                    bg-pink-600 font-medium rounded-full text-white px-8 py-3 cursor-pointer'>Continue Reading</span>
                </Link>
            </div>
        </div>
    )
